object LearningScala3 {
  ...
  val result1 = transformInt(3, squareIt)
  println(result1)
  ...
  //A function literal (below) can be called from a method
  val toUpperFn : (String) => String = x =>
  {
    x.toUpperCase
  }

  println(toUpper("Sri"))
  println(toUpperFn("Sri"))


  def callAnyStringFunction(f:(String) => String, str : String) = {
    f(str)
  }

  println(callAnyStringFunction(toUpperFn, "Srinivas")) //Any (String) => String fn can be
  // called
  println(toUpper("Srinivas")) //
}